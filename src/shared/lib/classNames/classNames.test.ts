...
describe('classNames', () => {
    ...
    test('classNames with additional', () => {
        expect(classNames('someClass', { hovered: false }, ['someClass1 someClass2'])).toBe('someClass someClass1 someClass2')
    })
    test('classNames not with mods', () => {
        expect(classNames('someClass', { hovered: false }, [])).not.toBe('someClass hovered')
    })
})